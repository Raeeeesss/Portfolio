...
import { HomeSkillsGrid } from "../components/SkillsGrid.jsx";import ProjItem from "../components/ProjItem.jsx";
import { IconEmail, IconArrow, IconGH, IconLinkedIn, IconPhone } from "../components/Icons.jsx";
  ...
  return (
    <>
        ...
        <div className="p-hero-content">
          ...
          <div className="p-hero-sub">
            <p className="p-hero-desc">
              <strong>Python Full-Stack Developer</strong> &amp; BCA student based in India.
              19 years old, building with Python, JavaScript, and a deep curiosity for AI.
            </p>
      ...
      <section className="p-sec" id="about">
        <div className="p-slabel p-rev"><div className="p-stag">01 — About</div><div className="p-srule" /></div>
        <div className="p-about-grid">
          <div className="p-about-body p-rev">
            ...
            <p>Currently exploring the intersection of web development and beginning to explore <strong>AI and Machine Learning</strong> — just getting started, but genuinely excited by where it's going.</p>
      ...
      <section className="p-sec" id="projects" style={{ borderTop: "1px solid var(--border)" }}>
        <div className="p-slabel p-rev"><div className="p-stag">02 — Work</div><div className="p-srule" /></div>
        ...
        <div style={{ marginTop: 40, display: "flex", gap: 16, flexWrap: "wrap" }}>
          <button className="p-btn" onClick={() => go("webdev")}><span>Web Dev Projects →</span></button>
          <button className="p-outline" onClick={() => go("appdev")}>App Dev Projects</button>
        </div>
      </section>

      {/* ── Skills ── */}
      <section className="p-sec" id="skills" style={{ borderTop: "1px solid var(--border)" }}>
        <div className="p-slabel p-rev"><div className="p-stag">03 — Skills</div><div className="p-srule" /></div>
        <div className="p-rev"><HomeSkillsGrid /></div>
      </section>

      {/* ── Contact ── */}
      <section className="p-sec" id="contact" style={{ borderTop: "1px solid var(--border)" }}>
        <div className="p-slabel p-rev"><div className="p-stag">04 — Contact</div><div className="p-srule" /></div>
        <div className="p-cgrid">
          <div className="p-rev">
            <div className="p-cey">Get in touch</div>
            <h2 className="p-chl">Let's build<br />something <em>great.</em></h2>
            <p className="p-cbody">Open to collaboration, freelance work, learning opportunities, and new challenges.</p>
          ...
          <div className="p-rev" style={{ transitionDelay: "0.12s" }}>
            <div className="p-form">
              <div className="p-ffield"><label className="p-flabel">Your name</label><input className="p-finput" placeholder="Alex Johnson" value={fname} onChange={e => setFname(e.target.value)} /></div>
              <div className="p-ffield"><label className="p-flabel">Email address</label><input className="p-finput" type="email" placeholder="alex@example.com" value={femail} onChange={e => setFemail(e.target.value)} /></div>
              <div className="p-ffield"><label className="p-flabel">Message</label><textarea className="p-ftextarea" placeholder="Tell me about your project or just say hello..." value={fmsg} onChange={e => setFmsg(e.target.value)} /></div>
